...
class HoldingItem extends Equatable {
  ...
  factory HoldingItem.fromJson(Map<String, dynamic> json) => HoldingItem(
        ...
        currentEstimate:
            _parseD(json['currentEstimate'] ?? json['current_estimate']),
        dayIncome: _parseD(json['dayIncome'] ?? json['day_income']),
        totalIncome: _parseD(json['totalIncome'] ?? json['total_income']),
        totalIncomeRate:
            _parseD(json['totalIncomeRate'] ?? json['total_income_rate']),
        investedAmount:
            _parseD(json['investedAmount'] ?? json['invested_amount']),
        buyDate: DateTime.tryParse(
                (json['buyDate'] ?? json['buy_date'] ?? '').toString()) ??
            DateTime.now(),
