    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _buildSection('通用', [
            _buildTile(Icons.notifications_outlined, '通知提醒', () {},
                trailing: const Icon(Icons.chevron_right, size: 18)),
            _buildThemeTile(),
            _buildTile(Icons.language, '语言', () {},
                trailing: const Icon(Icons.chevron_right, size: 18)),
          ]),
          _buildSection('数据', [
            _buildTile(Icons.sync, '同步数据', () {},
                trailing: const Icon(Icons.chevron_right, size: 18)),
            _buildTile(Icons.delete_outline, '清除缓存', () {},
                trailing: const Icon(Icons.chevron_right, size: 18)),
            _buildTile(Icons.backup_outlined, '备份与恢复', () {},
                trailing: const Icon(Icons.chevron_right, size: 18)),
          ]),
          _buildSection('其他', [
            _buildTile(Icons.info_outline, '关于', () {},
                trailing: const Text('v1.0.0',
                    style: TextStyle(fontSize: 13, color: AppTheme.textMuted))),
            _buildTile(Icons.help_outline, '帮助与反馈', () {},
                trailing: const Icon(Icons.chevron_right, size: 18)),
          ]),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Expanded(
                  child: Text('主题模式', style: TextStyle(fontSize: 16))),
              SegmentedButton<int>(
                segments: List.generate(
                    3,
                    (i) => ButtonSegment<int>(
                          value: i,
                          label: Text(_themeOptions[i],
